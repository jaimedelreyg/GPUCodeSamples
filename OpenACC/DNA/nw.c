...
void runTest( int argc, char** argv) 
{
	...
	/* Initialization */
#pragma acc data pcopy(nw_matrix[0:max_rows*max_cols])
...
#pragma acc data pcopy(tmp1[0:max_rows+max_cols],output1[0:max_rows+max_cols])
#pragma acc parallel loop gang
	for (int i=0; i<pos1; i++)
		output1[i] = tmp1[pos1-i-1];
	output1[pos1] = '\0';

#pragma acc data pcopy(tmp2[0:max_rows+max_cols],output2[0:max_rows+max_cols])
#pragma acc parallel loop gang
